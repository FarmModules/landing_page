    ...
    <div className="flex justify-center mt-[120px] w-[100%]">
      <div className="">
        <div className="text-[48px]">
          ...
          <span className="font-bold"> save 10s of hours</span> and <span className="font-bold">100s of USD per month </span>
          ...
          <br />
          <br />
          <span className="font-bold">Plug ‘n play IoT solution</span> to fullfill all your aquaponics
          automation, digitalization & optimisation needs:
        </div>

        <div className="mt-[80px] w-[100%]">
          <img
            src={'/graph.png'}
            style={{ objectFit: "contain", width: "100%", hight: "100%" }}
          />
        </div>
        ...
        <div className="text-[39px] mt-[310px]">
          ...
          <ul className="list-inside list-disc">
            <li>
              continuous measurements from sensors: pH, humidity, air
              temperature, water temperature and water level and possibility
              to add manual measurements to platform
            </li>
            <li>
              1 Integrated camera to see your farm online - 24/7 (more can be
              integrated)
            </li>
            <li>
              4x relays to connect devices to automate (e.g. LED, fan, fish
              feeder, ...)
            </li>
        ...
        <div className="mt-[55px]">
          <div className="bg-[#13ae5c] px-[5px] pt-[6px] pb-[8px] rounded-3xl w-[80%]" onClick={() => {
            handleClick()
          }}>
        ...
        <div className="mt-[65px] text-[39px]">
          ...
          <br />
          ✔️ Possibility to collaborate with us and our partners (universities and commercial farmers) on cutting edge aquaponics research
          <br />
          ✔️ Our in-house RnD teams, consisting of experts from fields of Hydroponics, Aquaculture, Electronics, 3D printing, AI and more, are working on making farms as optimized as possible for a given scale
        </div>

        <div className="mt-[55px] text-[39px] font-bold">
          Some of our academics & commercial customers
          and partners, including us (Farm Modules 👋):
        </div>
