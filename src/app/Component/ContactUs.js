        ...
        <footer className="bg-gray-200 py-10">
            <div className="container mx-auto" id="Contact">
                <div className="section-title-area">
                    <h2 className="section-title text-center">Let's build the farm of your dreams together</h2>
                </div>
                <div className="flex flex-wrap justify-center items-center">
                    <div className="w-full sm:w-1/2 px-4">
                        <h3 className="text-center">Join our Aquaponics Revolution</h3>
                        <p className="text-center">
                            <a href="https://tech.us5.list-manage.com/subscribe?u=b05e94f9647da65b3c325161c&amp;id=ac7f757457">
                                <button id="contact" className="btn btn-theme-primary btn-lg">Get free consultation</button>
                            </a>
                        </p>
                        <br /><br />
