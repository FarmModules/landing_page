...
const FarmModuleInput = () => {
    ...
    return (
        <div
            className="wrapper flex flex-col justify-center items-center"
            ...
            <div id="templateBody" className="bodyContent rounded-6">
                ...
                >
                    <div id="mergeTable" className="p-8">
                        <div
                            className="mergeRow dojoDndItem mergeRow-email flex items-center"
                            id="mergeRow-0"
                        >
                        ...
                        <div
                            className="mergeRow dojoDndItem mergeRow-text flex items-center"
                            id="mergeRow-1"
                        >
                        ...
                        <div id="mergeRow-3" className="flex items-center">
                        ...
                        <div
                            className="mergeRow dojoDndItem mergeRow-textarea p-4"
                            id="mergeRow-4"
                        >
                            <label htmlFor="MERGE4" className="p-2">Message: </label>
                            <textarea
                                name="MERGE4"
                                id="MERGE4"
                                rows="4"
                    ...
                    <div className="submit_container clear flex justify-center items-center">
                        <input
                            type="submit"
                            className="formEmailButton bg-gray-700 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded mt-4"
                            name="submit"
                            value="Send Enquiry"
                        />
                    </div>
